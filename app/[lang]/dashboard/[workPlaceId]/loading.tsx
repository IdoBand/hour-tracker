      ...
      >
        ...
        <>
          ...
          <div className="flex w-full md:flex-col">
            ...
            <div
              className={`flex w-1/2 flex-col shadow-lg rounded-lg p-4 gap-4 md:w-full md:px-2 md:text-sm`}
            >
              ...
              <div
                className={`p-1 flex w-full flex-col rounded-lg gap-1 relative`}
              >
                <span className="w-full font-semibold text-lg underline md: text-center">
                  Work Place Overview
                </span>
                ...
                <div className="absolute top-10 right-1 w-5">
        ...
        <div className="w-full gap-2">
          <div
            className={`w-full bg-sky-300 rounded-lg grid grid-cols-7 grid-flow-col px-2 py-1
            lg:grid-cols-3
          `}
          >
          ...
          <div className="w-full gap-2 flex-col">
            {Array.from({ length: 4 }, (_, i) => i + 1).map((i) => {
              return (
                <Skeleton
                  key={i}
                  className="w-full h-6 bg-skeletonLoading flex justify-between flex-col rounded-lg my-1 cursor-pointer relative"
                />
              );
            })}
          </div>
