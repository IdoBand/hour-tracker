        ...
        <div className='flex w-full md:flex-col'>
          ...
          <div className={`flex w-1/2 flex-col shadow-lg rounded-lg p-4 gap-4 md:w-full md:px-2 md:text-sm`}>
            ...
            <div className={`p-1 flex w-full flex-col rounded-lg gap-1 relative`}>
                ...
                <span>{`Employment Duration: `}<span className='font-semibold'>{`${totalHoursForPeriod(currentWorkPlace!.shifts)}`}</span></span>
                <span>{`Breaks Duration: `}<span className='font-semibold'>{`${totalBreakTime(currentWorkPlace!.shifts)}`}</span></span> */}
                <CustomButton 
